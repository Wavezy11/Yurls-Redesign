...
$subjectsLinks = [
    ...
    'Talen' => [
        ...
        'Techniek' => [
            ...
            ['text' => "VR/MR - Arkio (EN) [Architectuur]", 'url' => "https://www.meta.com/nl-nl/experiences/arkio/2280319701979278/"],
        ...
        'ICT' => [
            ...
            ['text' => "Game-based-learning - Seppo (NL, EN)", 'url' => "https://seppo.io/nl/"],
            ['text' => "App - Seppo (NL, EN)", 'url' => "https://seppo.io/nl/"],
        ],
...
// Loop through subjects and insert links
foreach ($subjectsLinks as $subject => $links) {
